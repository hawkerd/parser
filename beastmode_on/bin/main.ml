...
let string_of_declaration = Beastmode_on.string_of_statement
let mainParser = Beastmode_on.Parser.main
let mainLexer = Beastmode_on.Lexer.token
module Parser : (sig exception Error end) = Beastmode_on.Parser
